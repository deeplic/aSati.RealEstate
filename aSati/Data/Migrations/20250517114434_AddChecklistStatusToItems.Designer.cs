...
namespace aSati.Migrations
{
    ...
    [Migration("20250517114434_AddChecklistStatusToItems")]
    partial class AddChecklistStatusToItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("aSati.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("aSati.Shared.Models.Lease", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("aSati.Shared.Models.MainProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("aSati.Shared.Models.Lease", b =>
                {
                    ...
                    b.OwnsMany("aSati.Shared.Models.PropertyChecklistItem", "ChecklistItems", b1 =>
                        {
                            ...
                            b1.Property<string>("ActualState")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("Comment")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("ExpectedState")
                                .HasColumnType("nvarchar(max)");
                            ...
                            b1.HasKey("LeaseId", "Id");

                            b1.ToTable("PropertyChecklistItem");
